 ...
 */
final class Version20231028140316 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT NOT NULL, google_books_id VARCHAR(255) NOT NULL, title TEXT NOT NULL, subtitle TEXT DEFAULT NULL, publish_date DATE DEFAULT NULL, description TEXT DEFAULT NULL, isbn10 VARCHAR(255) DEFAULT NULL, isbn13 VARCHAR(255) DEFAULT NULL, page_count INT DEFAULT NULL, small_thumbnail TEXT DEFAULT NULL, thumbnail TEXT DEFAULT NULL, PRIMARY KEY(id))');
